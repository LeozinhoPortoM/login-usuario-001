...
//     check('apelido').notEmpty().withMessage('Campo obrigatório').bail().isString(),
...
//     check('confirmar_senha').notEmpty().withMessage('Campo obrigatório').bail().isLength({min: 6}).withMessage("A senha deve conter mais de 6 caracteres").bail(),
